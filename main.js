...
class Player {
    ...
    rollAttributes() {
        for (const key in this.attributes) {
            ...
            let sum = sumArrayElements(results); //sum of rolls
...
//Fisher-Yates algorithm from randomly sorting and array
//from: https://dev.to/codebubb/how-to-shuffle-an-array-in-javascript-2ikj
//adapted to JS and reconfigured to return new (non-muted) array
